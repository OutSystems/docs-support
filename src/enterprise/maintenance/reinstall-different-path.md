---
summary: OutSystems 11 (O11) reinstall on a different path by uninstalling, reconfiguring services, and restoring key files on on-premises servers.
locale: en-us
