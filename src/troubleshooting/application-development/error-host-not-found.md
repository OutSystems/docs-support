...
![OutSystems dashboard showing a notification that the personal environment fell asleep with a 'Wake up' button highlighted.](images/pe-sleep-usr.png"OutSystems Personal Environment Sleep State")

If your personal environment is deleted due to a long period of inactivity, click the **Fetch me a new environment** button.

![OutSystems dashboard indicating the personal environment was deleted due to inactivity with a 'Fetch a new environment' button highlighted.](images/pe-fetch-usr.png"OutSystems Personal Environment Deletion Notice")
