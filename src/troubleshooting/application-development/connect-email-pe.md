...
![OutSystems dashboard offering an option to download a backup of the previous environment.](images/download-backup-usr.png "OutSystems Download Backup Option")
