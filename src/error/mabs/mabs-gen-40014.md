---
summary: OS-MABS-GEN-40014 error on the OutSystems platform occurs when a Cordova plugin is incompatible with the Swift Language Version iOS build setting.
