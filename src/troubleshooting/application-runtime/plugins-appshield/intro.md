---
summary: Troubleshooting tips for the OutSystems 11 (O11) AppShield mobile plugin
  with Google AppsSigning are detailed, including encoding requirements and updates.
tags:
  - JavaScript
  - Mobile app
  - Platform Server
...
In LifeTime, if you edit the **Extensibility Configurations**, you must encode the value of the  **ApplicationSignerCertificate** key. To encode the value of the certificate, follow these steps:
...
1. Copy the output of the command as the new value for the **ApplicationSignerCertificate** key.
